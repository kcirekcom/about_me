...
function question1() {
    ...
    if (firstAnswer === 'yes' || firstAnswer === 'y') {
        ...
        console.log('That answer is incorrect. Wow. How on earth did you get that wrong?');
...
function question3() {
    var thirdAnswer = prompt('Do I have 30 baseball caps?')
...
function question6() {
    ...
    attempts++;
    if (favNumber !== sixthAnswer) {
        while (attempts < 4) {
            sixthAnswer = parseInt(prompt('Try again.'));
            attempts++;
...
function question7() {
    ...
    var rightGuess = true;
    var seventhAnswer = prompt('What sports do I play? You will be given 6 chances to guess the correct answer.');
    numberAttempts++;
    for (var i = 0; i <= 6; i++) {
        if (seventhAnswer === sportsPlayed[i]) {
            alert('Good job! I do play that sport!');
            console.log(userName + ' answered this question correctly!');
            break;
        } else {
            if (numberAttempts < 6) {
                for (var j in sportsPlayed) {
                    if (seventhAnswer === sportsPlayed[j]) {
                        alert('Good job! I do play that sport!');
                        console.log(userName + ' answered this question correctly!');
                        break;
                    } else {
                        seventhAnswer = prompt('Wrong guess. Try again');
                        numberAttempts++;
                    }
                }
            } else {
...
//function invocation (calling the function to run)
question1();
question2();
question3();
question4();
