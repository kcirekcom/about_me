...
parseInt(prompt('What is my favorite number? You will be given 4 chances to guess the correct number.'));
var favNumber = 5;
var attempts = 0;
var wrongGuess = true;
while (attempts < 4) {
  attempts++;
  var sixthAnswer = parseInt(prompt('Try again.'));
...
prompt('What sports do I play? You will be given 6 chances to guess the correct answer.');
var sportsPlayed = ['golf', 'baseball', 'soccer', 'basketball'];
var numberAttempts = 0;
var rightGuess = true;
while (numberAttempts < 6 && rightGuess) {
  numberAttempts++;
  var seventhAnswer = prompt('Wrong guess. Try again.').toLowerCase();
